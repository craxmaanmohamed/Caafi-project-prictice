        ...
        <div class="grid max-w-md grid-cols-1 gap-6 mx-auto mt-8 lg:mt-16 lg:grid-cols-3 lg:max-w-full">
            ...
            <div class="overflow-hidden bg-white rounded shadow">
                <div class="p-5">
                    <div class="relative">
                        <a href="#" title="" class="block aspect-w-4 aspect-h-3">
                            <Image width={100} height={100} class="object-cover w-full h-[230px]" src="/images/blogImg2.jpg" alt="" />
                        </a>
            ...
            <div class="overflow-hidden bg-white rounded shadow">
                <div class="p-5">
                    <div class="relative">
                        <a href="#" title="" class="block aspect-w-4 aspect-h-3">
                            <Image width={100} height={100} class="object-cover w-full h-[230px]" src="/images/blogImg3.jpg" alt="" />
                        </a>
                    </div>

        ...
        <div class="grid max-w-md grid-cols-1 gap-6 mx-auto mt-8 lg:mt-16 lg:grid-cols-3 lg:max-w-full">
                ...
                <div class="p-5">
                    <div class="relative">
                        <a href="#" title="" class="block aspect-w-4 aspect-h-3">
                            <img class="object-cover w-full h-[230px]" src="/images/blogImg1.jpg" alt="" />
                        </a>
            ...
            <div class="overflow-hidden bg-white rounded shadow">
                <div class="p-5">
                    <div class="relative">
                        <a href="#" title="" class="block aspect-w-4 aspect-h-3">
                            <img class="object-cover w-full h-[230px]" src="/images/blogImg2.jpg" alt="" />
                        </a>

                        
                    </div>
                    <span class="block mt-6 text-sm font-semibold tracking-widest text-gray-500 uppercase"> june 04, 2024</span>
                    <p class="mt-5 text-2xl font-semibold">
                        <a href="#" title="" class="text-black">Faa'idada cabista biiyaha laga helo  </a>
                    </p>
                    <p class="mt-4 text-base text-gray-600">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</p>
                    <a href="#" title="" class="inline-flex items-center justify-center pb-0.5 mt-5 text-base font-semibold text-pr-color transition-all duration-200 border-b-2 border-transparent hover:border-pr-color ">
                    Read More
            ...
            <div class="overflow-hidden bg-white rounded shadow">
                <div class="p-5">
                    <div class="relative">
                        <a href="#" title="" class="block aspect-w-4 aspect-h-3">
                            <img class="object-cover w-full h-[230px]" src="/images/blogImg3.jpg" alt="" />
                        </a>
                    </div>
                    <span class="block mt-6 text-sm font-semibold tracking-widest text-gray-500 uppercase"> june 02, 2024</span>
                    <p class="mt-5 text-2xl font-semibold">
                        <a href="#" title="" class="text-black"> qaabka loo ilaaliyo biiyaha xaafadaha </a>
                    </p>
                    <p class="mt-4 text-base text-gray-600">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</p>
                    <a href="#" title="" class="inline-flex items-center justify-center pb-0.5 mt-5 text-base font-semibold text-pr-color transition-all duration-200 border-b-2 border-transparent hover:border-pr-color">
                    Read More
